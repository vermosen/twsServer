...
namespace IB {
	...
	namespace utilities {
		...
		void registerBarSize() {
			...
			barSizeFactory createBarSize;

			createBarSize.registerType("1 sec"       , new IB::barSize(IB::oneSecond     ));
			createBarSize.registerType("5 secs"      , new IB::barSize(IB::fiveSeconds   ));
			createBarSize.registerType("15 secs"     , new IB::barSize(IB::fifteenSeconds));
			createBarSize.registerType("30 secs"     , new IB::barSize(IB::thirtySeconds ));
			createBarSize.registerType("1 min"       , new IB::barSize(IB::oneMinute     ));
			createBarSize.registerType("2 mins"      , new IB::barSize(IB::twoMinutes    ));
