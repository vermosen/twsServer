...
namespace IB {
	...
	namespace dataBase {
		...
		tableContractRecordset2::tableContractRecordset2(MYSQL * connection) 
			: recordset2(connection) {};

		bool tableContractRecordset2::selectStr(const std::string & selectStr) {
		...
		bool tableContractRecordset2::insert(const ContractDetails & details) {
		...
		bool tableContractRecordset2::deleteStr(const std::string & deleteStr) {
